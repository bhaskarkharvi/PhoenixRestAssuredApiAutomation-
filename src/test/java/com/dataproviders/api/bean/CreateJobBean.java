...
//Private instance variable  mapped to columnsname as below by @CSVBindByName() method
...
private String problems__remark;
	...
	public void setCustomer_product__popurl(String customer_product__dop) {
		this.customer_product__dop = customer_product__dop;
	}
	...
	public String toString() {
		return "CreateJobBean [mst_service_location_id=" + mst_service_location_id + ", mst_platform_id="
				...
				+ ", customer_product__popurl=" + customer_product__dop + ", customer_product__product_id="
