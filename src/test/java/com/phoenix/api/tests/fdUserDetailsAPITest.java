...
public class fdUserDetailsAPITest {
	...
	//Header authToken= new Header("Authorization",AuthTokenProvider.getToken());
	Header authToken= new Header("Authorization",getToken(Role.FD));//becoz static import of class
